...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Energon " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"energontools.com", "144.202.38.247"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"energontools.com", "testnet-seed.energontools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Energon is probably already running."), addrBind.ToString().c_str());
        else
